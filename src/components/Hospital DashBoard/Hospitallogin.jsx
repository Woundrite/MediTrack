      ...
      <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl max-md:max-w-md w-full">
        <div>
          <h2 class="lg:text-5xl text-3xl font-bold lg:leading-[57px] text-slate-900">
                MediTrack Seamless Login for Access To Dashboard
          </h2>
          <p class="text-sm mt-6 text-slate-500 leading-relaxed">Login To Yor Dashboard Hastle Free</p>
          <p class="text-sm mt-12 text-slate-500">Don't have an account <Link to="/hospital/registration" class="text-blue-600 font-medium hover:underline ml-1">Register here</Link></p>
        </div>
